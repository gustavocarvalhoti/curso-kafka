...
public class KafkaService<T> implements Closeable {
    ...
    private Properties getProperties(String groupId, Map<String, String> overrideProperties) {
        ...
        // Consumer resetou ele pega a ultima mensagem
        // smallest = Ultima armazenada em disco
        // largest = Maior de todos se não tem informação do offset
        // disable = Para de consumir
        // latest = Utilizar esse (Processa a ultima)
        // earliest = Processa desde a inicial
